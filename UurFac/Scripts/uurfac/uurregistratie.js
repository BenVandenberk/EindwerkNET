$(function () {
    ...
    $('#tbl_uurregistraties').jtable({
        ...
        actions: {
            listAction: '/UurRegistraties/ListUurRegistraties?gefactureerd=false',
            updateAction: '/UurRegistraties/Update',
            deleteAction: '/UurRegistraties/Delete',
            createAction: function (postData, jtParams) {
                return $.Deferred(function ($dfd) {
                    $.ajax({
                        url: '/UurRegistraties/NieuweUurRegistratie?gebruikerKlantId=' + selectedGebruikerKlantId().Id,
                        type: 'POST',
                        dataType: 'json',
                        data: postData,
...
function uurRegistratieDetailsClick(event) {
    ...
    '<input type="text" name="gefactureerd" value="false" />' +
    '</form>');
    $('body').append(form);
    form.submit();
}
